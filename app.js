...
var seattle = {
  ...
  renderToDom: function ()  {
    ...
    for (var i = 0; i < this.cookieArray.length; i++) {
      ...
      newLi.textContent = this.newArray[i] +  ': ' + this.cookieArray[i] + ' cookies'
